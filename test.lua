...
--Tables
Library = {
    FontFace=Font.new("rbxasset://fonts/families/Gotham.json",Enum.FontWeight.Medium),
    Colors = {
    Background = Color3.fromRGB(30, 30, 36), -- Abu-abu gelap modern
    ItemBorder = Color3.fromRGB(50, 50, 60), -- Batas netral
    ItemBackground = Color3.fromRGB(40, 44, 52), -- Latar elemen sedikit lebih terang
    Text = Color3.fromRGB(245, 245, 245), -- Tetap putih untuk keterbacaan
    Active = Color3.fromRGB(88, 101, 242), -- Biru muda neon sebagai aksen
    DisabledText = Color3.fromRGB(150, 150, 150), -- Abu-abu lebih terang untuk teks non-aktif
    Risky = Color3.fromRGB(235, 63, 63), -- Merah cerah untuk peringatan
    },
    Functions = {},
    Flags = {},
    Connections = {},
...
makefolder("Rbx_Script")
makefolder("Rbx_Script/Ui")
makefolder("Rbx_Script/Ui/Themes")
makefolder("Rbx_Script/Ui/Games")

--Functions
local ThemeManager = {} do
	ThemeManager.Folder = 'Rbx_Script/Ui/Themes'
	ThemeManager.Library = nil
	ThemeManager.BuiltInThemes = {
        ['Default'] = {1, HttpService:JSONDecode('{"DisabledText":{"Rainbow":false,"HexColor":"969696"},"ItemBorder":{"Rainbow":false,"HexColor":"32323c"},"Active":{"Rainbow":false,"HexColor":"5865f2"},"Background":{"Rainbow":false,"HexColor":"1e1e24"},"ItemBackground":{"Rainbow":false,"HexColor":"282c34"},"Text":{"Rainbow":false,"HexColor":"f5f5f5"}}')};
...
local SaveManager = {} do
	SaveManager.Folder = "Rbx_Script/Ui/Games"
	SaveManager.Ignore = {}
	SaveManager.Parser = {
		Toggle = {
...
local WatermarkOuter = Library.Functions:Create('Frame', {
    BorderSizePixel = 0;
    Position = UDim2.new(0.5, 0, 0, 20); -- Tengah secara horizontal, 20px dari atas
    AnchorPoint = Vector2.new(0.5, 0);   -- Titik acuan di tengah atas
    Size = UDim2.new(0, 20, 0, 20);
    ZIndex = 200;
    Visible = false;
    Parent = ScreenGui;
...
function Library:Notify(Info)
    do
        ...
        local NotificationShadow = Library.Functions:Create('UIStroke', {
        ...
        local NotificationCorner = Library.Functions:Create('UICorner', {CornerRadius=UDim.new(0,8),Parent=NotificationOuter})
...
function Library:CreateWindow(...)
    ...
    local BackgroundCorner = Library.Functions:Create('UICorner', {CornerRadius=UDim.new(0,8),Parent=Background})
    ...
    local WindowLabel = Library.Functions:Create("TextLabel",{
        ...
        TextSize=18,
        Text = 'Rbx<font color="#'..Library.Colors["Active"]:ToHex()..'">Script</font>' ..Config.Title or "";
        ZIndex = 1;
        Parent = Background;
    });
    function Library.Functions:UpdateColors()
        ...
        WindowLabel.Text = 'Rbx<font color="#'..Library.Colors["Active"]:ToHex()..'">Script</font>' ..Config.Title or "";
    end
